        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            <div className="max-w-3xl space-y-6">
              ...
              <div className="space-y-3">
                <h1 className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 bg-clip-text text-4xl font-extrabold tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-6xl">
                  Veer Bharat
                </h1>
                <p className="text-sm uppercase tracking-wider text-[#08348b] font-semibold">
                  Delivering pure goodness from nature to your kitchen
                </p>
                <div className="h-1 w-28 rounded-full bg-gradient-to-r from-slate-900/80 to-orange-400"></div>
              </div>

              {/* Main Description (short, clear, screenshot-like) */}
              <p className="text-lg leading-relaxed text-slate-800 sm:text-xl md:text-xl">
                Sri Shyam Agro Industries — makers of <strong>Veer Bharat</strong> edible oils — has been committed to purity, quality and taste since <strong>2000</strong>. We combine traditional methods with modern processing to ensure every bottle is safe, nutritious and flavorful.
              </p>

              {/* Quick highlights and product links (inline chips) */}
              <div className="flex flex-wrap gap-3">
                <Link href="/mustard-oil" className="inline-flex items-center gap-2 rounded-full border bg-white/90 px-3 py-1 text-sm font-medium shadow-sm hover:scale-[1.02] transition">
                   Kachi Ghani Mustard Oil
                </Link>

                <Link href="/soyabean-oil" className="inline-flex items-center gap-2 rounded-full border bg-white/90 px-3 py-1 text-sm font-medium shadow-sm hover:scale-[1.02] transition">
                   Soybean Oil
                </Link>

                <Link href="/palm-oil" className="inline-flex items-center gap-2 rounded-full border bg-white/90 px-3 py-1 text-sm font-medium shadow-sm hover:scale-[1.02] transition">
                   Palm Oil
                </Link>
              </div>
              ...
              <div className="space-y-4 text-slate-800">
                ...
                <p className="text-base md:text-lg">
                  <strong>Family-first quality.</strong> Developed for everyday cooking, our range supports healthy, tasty meals for all ages.
                </p>
              </div>
              ...
              <div className="pt-2 flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-slate-900 to-blue-900 px-6 py-3 text-base font-semibold text-white shadow-lg hover:scale-105 transition"
                >
                  Get in touch
                </Link>
                ...
                <Link
                  href="/products"
                  className="inline-flex items-center justify-center rounded-2xl border border-slate-900 px-6 py-3 text-base font-semibold text-slate-900 bg-white/90 shadow-sm hover:bg-white transition"
                >
                  View all products
                </Link>
              </div>
          ...
          >
            <div className="group relative h-[420px] w-full max-w-[680px] overflow-hidden rounded-3xl shadow-2xl transition-transform duration-500 hover:scale-[1.02]">
              ...
              {/* Subtle label badges on image linking to specific product pages */}
              {/* <div className="absolute left-6 bottom-6 flex flex-col gap-2">
                <Link href="/mustard-oil" className="inline-flex items-center gap-2 rounded-full bg-red-600/90 px-3 py-2 text-xs font-semibold text-white shadow">
                  Kachi Ghani Mustard
                </Link>
                <Link href="/soyabean-oil" className="inline-flex items-center gap-2 rounded-full bg-green-600/90 px-3 py-2 text-xs font-semibold text-white shadow">
                  Soybean Oil
                </Link>
              </div> */}

              {/* Decorative corner accent */}
              <div className="absolute -left-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-tr from-yellow-200 to-orange-300 opacity-40 blur-2xl pointer-events-none"></div>
            </div>
          </div>
        </div>
      </div>

...
//           Mustard Oil Tradition Meets Nutrition
//           </span>
//         </motion.h1>
...
//             className={`${playfair.className} text-3xl md:text-5xl lg:text-6xl font-extrabold text-white max-w-4xl`}
//           >
//             Veer Bharat Mustard Oil Tradition Meets Nutrition
//           </motion.h1> */}
...
//       meta.content = 'r98v6O5kAtTe-6BdgRB11PQgQTopFn7x464rMPuWkIQ';
...
//       {/* ---------- NARROWER, CENTERED HEADING BLOCK ---------- */}
//       <div className="py-12 md:py-16 lg:py-20 text-center bg-gradient-to-b from-white to-gray-50/40">
//         {/* Narrow, centered container so heading doesn't span full page width */}
//         <div className="mx-auto featured-container px-4">
//           {/* Single-line H1 (desktop), wraps on small devices */}
//           <motion.h1
...
//               text-center
//             `}
//             aria-label="Welcome to Veer Bharat"
//             title="Welcome to Veer Bharat"
//           >
//             Welcome to Veer Bharat,
//           </motion.h1>

//           {/* Subtitle / Tagline that visually matches heading width */}
//           <motion.p
...
//           {/* Decorative underline sized to match the narrower visual block */}
//           <motion.div
//             initial={{ scaleX: 0, opacity: 0 }}
//             whileInView={{ scaleX: 1, opacity: 1 }}
//             transition={{ duration: 0.7, delay: 0.26, ease: "easeOut" }}
//             viewport={{ once: true }}
//             className="mt-6 md:mt-8 mx-auto h-1.5 rounded-full bg-gradient-to-r from-amber-400 via-orange-500 to-green-600 shadow-lg shadow-amber-200/50"
//             style={{ width: "260px" }}
//           />
  ...
  return (
    <main className={`${poppins.className} bg-[#fef9c3] text-[#0b0d11]`}>
      ...
      <div className="relative py-8 md:py-10 overflow-hidden bg-gradient-to-b from-white via-amber-50/30 to-gray-50/50">
        <div className="flex flex-wrap justify-center items-center gap-x-2 md:gap-x-4 px-3 md:px-6">
          {"Welcome to Veer Bharat,".split(" ").map((word, index) => (
            <motion.span
              key={index}
              className={`
                ${playfair.className} 
                ...
                bg-gradient-to-br from-amber-800 via-orange-700 to-red-800
                bg-clip-text text-transparent
                inline-block
                drop-shadow-2xl
              `}
        ...
        <motion.div
          className="mt-4 md:mt-6 flex flex-wrap justify-center items-center gap-x-2 md:gap-x-3 px-3 md:px-6"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 2, duration: 1 }}
        >
          {"Purity You Can Taste, Quality You Can Trust.".split(" ").map((word, index) => (
            <motion.span
              key={index}
              className={`
                ${playfair.className}
        ...
        <motion.div
          className="mt-5 md:mt-7 w-56 md:w-72 lg:w-96 mx-auto h-1 rounded-full 
                     bg-gradient-to-r from-amber-500 via-orange-600 to-red-500
                     shadow-xl shadow-orange-300/60"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
          transition={{
            duration: 1.2,
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
          <motion.div
            className="absolute top-10 left-10 w-32 h-32 rounded-full bg-amber-200/20 blur-3xl"
            animate={{
              scale: [1, 1.2, 1],
              x: [0, 30, 0],
              y: [0, -20, 0],
          ...
          />
          <motion.div
            className="absolute bottom-10 right-10 w-40 h-40 rounded-full bg-orange-200/20 blur-3xl"
            animate={{
              scale: [1, 1.3, 1],
              x: [0, -30, 0],
              y: [0, 20, 0],
      ...
      <style jsx>{`
        /* Narrower centered block: desktop ~920px, tablet ~760px, mobile fluid */
        .featured-container {
          max-width: 920px; /* desktop: narrower than full width */
        }
        @media (max-width: 1200px) {
          .featured-container {
            max-width: 760px; /* tablet/laptop */
          }
        }
        @media (max-width: 640px) {
          .featured-container {
          ...
          /* On small screens allow heading to wrap naturally */
          .featured-heading {
...
/* The rest of your components below (CategoriesGrid, VideoShowcase, etc.) stay unchanged */
...
function CategoriesGrid() {
  const categories = [
    ...
    },
    {
      ...
      description:
        "Light & neutral soybean oil ideal for everyday cooking. High smoke point, rich in omega-3 fatty acids, suitable for frying, baking, and salad dressings.",
    },
    {
      id: "cat-3",
      name: "Palm Oil",
      ...
      description:
        "Pam oil with high stability for deep frying. Neutral taste, ideal for commercial kitchens. Our plam oil is sourced from sustainable plantations and refined to ensure quality and safety.",
    },
    {
      id: "cat-4",
      name: "Rice Brand",
      ...
      description:
        "we offer premium rice bran and refined rice bran oil, known for its health benefits and cooking versatility. we source our rice bran from the finest rice mills, ensuring high quality and purity.",
    },
  ];
